...
{
    {
        auto const ip_str = print_ip( int8_t{-1} ); // 255
        EXPECT_EQ(ip_str, "255");
    }

    {
        auto const ip_str = print_ip( int16_t{0} ); // 0.0
        EXPECT_EQ(ip_str, "0.0");
    }

    {
        auto const ip_str = print_ip( int32_t{2130706433} );
        EXPECT_EQ(ip_str, "127.0.0.1");
    }

    {
        auto const ip_str = print_ip( int64_t{8875824491850138409} );
